"""Credit: https://github.com/fomorians/gym_pycolab/blob/master/gym_pycolab/pycolab_env.py"""
...
class PyColabEnv(gym.Env):
    ...
    def _update_for_game_step(self, observations, reward):
        ...
        self._last_state = self._paint_board(observations.layers).astype(np.float32)
